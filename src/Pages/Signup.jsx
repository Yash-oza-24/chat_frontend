...
import { FaUser, FaLock, FaSkype, FaUserCircle } from "react-icons/fa";
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let fullname = fnameRef.current.value;
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-[1.02]">
          <div className="p-8">
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="text-white/80 mt-2">Join Skype today</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-white text-[#0078d7] py-3 rounded-lg font-semibold hover:bg-white/90 transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/30 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
